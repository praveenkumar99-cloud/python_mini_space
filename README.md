[![View My Profile](https://img.shields.io/badge/View-My_Profile-green?logo=GitHub)](https://github.com/praveenkumar99-cloud)
...
> A collection of easy Python small projects to help you improve my programming skills.
...
On the [GitHub page for this repository](https://github.com/praveenkumar99-cloud/python_projects), click on the Button "**Fork**".
...
- Create a folder in
  [projects directory](https://github.com/praveenkumar99-cloud/python_projects) according to your project name.
...
- Don't forget to add a `README.md` in your folder, according to the
  [README_TEMPLATE.](https://github.com/praveenkumar99-cloud/python_projects/blob/master/README_TEMPLATE.md)
